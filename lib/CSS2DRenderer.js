...
THREE.CSS2DRenderer = function () {
	...
	var renderObject = function ( object, camera ) {
		...
		if ( object instanceof THREE.CSS2DObject ) {
			...
			var style = 'translate('+(element.showPosition.indexOf('left')!=-1?'-100%':'0%')+','+(element.showPosition.indexOf('bottom')!=-1?'0%':'-100%')+') translate(' + ( vector.x * _widthHalf + _widthHalf ) + 'px,' + ( - vector.y * _heightHalf + _heightHalf ) + 'px)';
